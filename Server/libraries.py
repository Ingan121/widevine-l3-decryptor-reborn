...
class Library:
    ...
    def connect_cdm(self):
        self.cdm = sqlite3.connect('cdms.db', isolation_level=None)
        self.cdm.cursor()
    ...
    def cdm_selector(self, blob_id):
        ...
        self.close_cdm()
        return data #samsung/heroltelgt/heroltelgt:8.0.0/R16NW/G930LKLU2ESA2:user/release-keys
